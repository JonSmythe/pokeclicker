...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// For helper functions that may be needed across all files\r\n// TODO: Convert this to not be a class after everything is TS modules\r\nconst LogEvent = (event, event_category, event_label, value) => {\r\n    try {\r\n        gtag('event', event, {\r\n            event_category,\r\n            event_label,\r\n            value,\r\n        });\r\n    }\r\n    catch (e) {\r\n        console.warn('Failed to send event data.');\r\n    }\r\n};\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (LogEvent);\r\n\n\n//# sourceURL=webpack:///./src/modules/LogEvent.ts?");

/***/ }),

/***/ "./src/modules/SaveSelector.ts":
/*!*************************************!*\
  !*** ./src/modules/SaveSelector.ts ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ChangelogUpdate; });\n/* harmony import */ var _Changelog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Changelog */ \"./src/modules/changelog/Changelog.ts\");\n\r\nclass ChangelogUpdate extends _Changelog__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n    constructor(version, date) {\r\n        const dateFormat = { year: 'numeric', month: 'long', day: 'numeric' };\r\n        const description = `<code>${version}  -  ${date.toLocaleDateString(undefined, dateFormat)}</code>`;\r\n        super(_Changelog__WEBPACK_IMPORTED_MODULE_0__[\"changelogType\"].UPDATE, description);\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/modules/changelog/ChangelogUpdate.ts?");

/***/ }),

/***/ "./src/modules/codes/RedeemableCode.ts":
/*!*********************************************!*\
  !*** ./src/modules/codes/RedeemableCode.ts ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return LogBook; });\n/* harmony import */ var _LogBookLog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LogBookLog */ \"./src/modules/logbook/LogBookLog.ts\");\n/* harmony import */ var _LogBookTypes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LogBookTypes */ \"./src/modules/logbook/LogBookTypes.ts\");\n\r\n\r\nclass LogBook {\r\n    constructor() {\r\n        this.name = 'Log Book';\r\n        this.saveKey = 'logbook';\r\n        this.filters = Object.keys(_LogBookTypes__WEBPACK_IMPORTED_MODULE_1__[\"LogBookTypes\"]).reduce((_dict, setting) => Object.assign(_dict, { [setting]: ko.observable(true).extend({ boolean: null }) }), {});\r\n        this.logs = ko.observableArray([]);\r\n        this.filteredLogs = ko.pureComputed(() => this.logs().filter((log) => { var _a, _b; return (_b = (_a = this.filters)[log.type.label]) === null || _b === void 0 ? void 0 : _b.call(_a); }));\r\n    }\r\n    newLog(type, message) {\r\n        const length = this.logs.unshift(new _LogBookLog__WEBPACK_IMPORTED_MODULE_0__[\"default\"](type, message));\r\n        if (length > 1000) {\r\n            this.logs.pop();\r\n        }\r\n    }\r\n    fromJSON(json) {\r\n        var _a;\r\n        if (json == null) {\r\n            return;\r\n        }\r\n        (_a = json.logs) === null || _a === void 0 ? void 0 : _a.forEach((entry) => {\r\n            this.logs.push(new _LogBookLog__WEBPACK_IMPORTED_MODULE_0__[\"default\"](entry.type, entry.description, entry.date));\r\n        });\r\n        Object.entries(json.filters || {}).forEach(([key, value]) => {\r\n            var _a, _b;\r\n            (_b = (_a = this.filters)[key]) === null || _b === void 0 ? void 0 : _b.call(_a, value);\r\n        });\r\n    }\r\n    toJSON() {\r\n        return ko.toJS({\r\n            logs: this.logs.slice(0, 100),\r\n            filters: this.filters,\r\n        });\r\n    }\r\n    initialize() { }\r\n    canAccess() {\r\n        return true;\r\n    }\r\n    update() { } // This method intentionally left blank\r\n}\r\n\n\n//# sourceURL=webpack:///./src/modules/logbook/LogBook.ts?");

/***/ }),

/***/ "./src/modules/logbook/LogBookLog.ts":
/*!*******************************************!*\
  !*** ./src/modules/logbook/LogBookLog.ts ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return LogBookLog; });\nclass LogBookLog {\r\n    constructor(type = {\r\n        display: 'dark',\r\n        label: 'OTHER',\r\n    }, description = 'Unknown entry', date = Date.now()) {\r\n        this.type = type;\r\n        this.description = description;\r\n        this.date = date;\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/modules/logbook/LogBookLog.ts?");

/***/ }),

/***/ "./src/modules/logbook/LogBookTypes.ts":
/*!*********************************************!*\
  !*** ./src/modules/logbook/LogBookTypes.ts ***!
  \*********************************************/
/*! exports provided: LogBookTypes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"LogBookTypes\", function() { return LogBookTypes; });\nconst LogBookTypes = {\r\n    NEW: {\r\n        display: 'primary',\r\n        label: 'NEW',\r\n    },\r\n    SHINY: {\r\n        display: 'warning',\r\n        label: 'SHINY',\r\n    },\r\n    CAUGHT: {\r\n        display: 'success',\r\n        label: 'CAUGHT',\r\n    },\r\n    ESCAPED: {\r\n        display: 'danger',\r\n        label: 'ESCAPED',\r\n    },\r\n    FOUND: {\r\n        display: 'primary',\r\n        label: 'FOUND',\r\n    },\r\n    ACHIEVE: {\r\n        display: 'warning',\r\n        label: 'ACHIEVE',\r\n    },\r\n    QUEST: {\r\n        display: 'info',\r\n        label: 'QUEST',\r\n    },\r\n    WANDER: {\r\n        display: 'primary',\r\n        label: 'WANDER',\r\n    },\r\n    OTHER: {\r\n        display: 'dark',\r\n        label: 'OTHER',\r\n    },\r\n};\r\n\n\n//# sourceURL=webpack:///./src/modules/logbook/LogBookTypes.ts?");

/***/ }),

/***/ "./src/modules/multiplier/Multiplier.ts":
/*!**********************************************!*\
  !*** ./src/modules/multiplier/Multiplier.ts ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../settings/BooleanSetting */ \"./src/modules/settings/BooleanSetting.ts\");\n/* harmony import */ var _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utilities/Sound */ \"./src/modules/utilities/Sound.ts\");\n/* harmony import */ var _NotificationOption__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./NotificationOption */ \"./src/modules/notifications/NotificationOption.ts\");\n\r\n\r\n\r\n/**\r\n * Contains all notification constants for easy access.\r\n */\r\nconst NotificationConstants = {\r\n    NotificationOption: _NotificationOption__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\r\n    NotificationSound: {\r\n        ready_to_hatch: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('ready_to_hatch', 'Egg ready to hatch'),\r\n        empty_queue: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('empty_queue', 'Hatchery queue is empty'),\r\n        shiny_long: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('shiny_long', 'Shiny Pokémon encountered/hatched'),\r\n        new_catch: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('new_catch', 'New Pokémon/shiny captured'),\r\n        achievement: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('achievement', 'New achievement earned'),\r\n        battle_item_timer: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('battle_item_timer', 'Battle item about to wear off'),\r\n        quest_ready_to_complete: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('quest_ready_to_complete', 'Quest is ready to be completed'),\r\n        quest_level_increased: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('quest_level_increased', 'Quest level increased'),\r\n        underground_energy_full: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('underground_energy_full', 'Mining energy reached maximum capacity'),\r\n        ready_to_harvest: new _utilities_Sound__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('ready_to_harvest', 'Farm ready to harvest'),\r\n    },\r\n    NotificationSetting: {\r\n        ready_to_hatch: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.ready_to_hatch', 'Egg ready to hatch', true),\r\n        hatched: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.hatched', 'Egg hatched', true),\r\n        hatched_shiny: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.hatched_shiny', 'Egg hatched a shiny', true),\r\n        empty_queue: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('empty_queue', 'Hatchery queue is empty', true),\r\n        route_item_found: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.route_item_found', 'Item found during route battle', true),\r\n        dungeon_item_found: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.dungeon_item_found', 'Item found in dungeon chest', true),\r\n        battle_item_timer: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.battle_item_timer', 'Battle item about to wear off', true),\r\n        encountered_shiny: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.encountered_shiny', 'Encountered a shiny Pokémon', true),\r\n        quest_ready_to_complete: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.quest_ready_to_complete', 'Quest is ready to be completed', true),\r\n        underground_energy_full: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.underground_energy_full', 'Mining energy reached maximum capacity', true),\r\n        event_start_end: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.event_start_end', 'Event start/end information', true),\r\n        dropped_item: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.dropped_item', 'Enemy Pokémon dropped an item', true),\r\n        ready_to_harvest: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.ready_to_harvest', 'Berry ready to harvest', true),\r\n        gym_won: new _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('notification.gym_won', 'Gym leader defeated', true),\r\n    },\r\n};\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (NotificationConstants);\r\n\n\n//# sourceURL=webpack:///./src/modules/notifications/NotificationConstants.ts?");

/***/ }),

/***/ "./src/modules/notifications/NotificationOption.ts":
/*!*********************************************************!*\
  !*** ./src/modules/notifications/NotificationOption.ts ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Profile; });\n/* harmony import */ var _GameConstants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../GameConstants */ \"./src/modules/GameConstants.ts\");\n/* harmony import */ var _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utilities/Rand */ \"./src/modules/utilities/Rand.ts\");\n\r\n\r\nclass Profile {\r\n    constructor(name = 'Trainer', trainer = _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__[\"default\"].floor(Profile.MAX_TRAINER), pokemon = 0, background = _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__[\"default\"].floor(Profile.MAX_BACKGROUND), textColor = '#f5f5f5') {\r\n        this.saveKey = 'profile';\r\n        this.defaults = {};\r\n        this.name = ko.observable(name);\r\n        this.trainer = ko.observable(trainer).extend({ numeric: 0 });\r\n        this.pokemon = ko.observable(pokemon).extend({ numeric: 2 });\r\n        this.pokemonShiny = ko.observable(false).extend({ boolean: null });\r\n        this.background = ko.observable(background).extend({ numeric: 0 });\r\n        this.textColor = ko.observable(textColor);\r\n    }\r\n    static getTrainerCard(name = 'Trainer', trainer = _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__[\"default\"].floor(Profile.MAX_TRAINER), pokemon = _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__[\"default\"].intBetween(1, 151), pokemonShiny = false, background = _utilities_Rand__WEBPACK_IMPORTED_MODULE_1__[\"default\"].floor(Profile.MAX_BACKGROUND), textColor = 'whitesmoke', badges = 0, pokedex = 0, seconds = 0, version = '0.0.0', challenges = {}, key) {\r\n        const challengeRibbonsPath = 'assets/images/challenges/';\r\n        return `\n        <div class=\"mb-3 ${key === undefined ? 'p-2 col-12' : 'col-lg-4 col-md-6 col-sm-12 xol-xs-12'}\">\n            <div class=\"trainer-card clickable trainer-bg-${background} card font-weight-bold\"\n                ${key === undefined ? '' : `data-key=\"${key}\"`}\n                style=\"color: ${textColor}\"\n                onclick=\"${key === undefined ? \"Notifier.notify({ message: 'What a lovely profile!' });\" : `Save.key = '${key}'; document.querySelector('#saveSelector').remove(); App.start();`}\">\n                <div class=\"card-body\">\n                    <h5 class=\"align-middle font-weight-bold\"><img src=\"assets/images/profile/trainer-${trainer}.png\"/> ${_GameConstants__WEBPACK_IMPORTED_MODULE_0__[\"cleanHTMLString\"](name)}</h5>\n                    <table class=\"table table-sm table-borderless col-8\" style=\"color: ${textColor}\">\n                        <tbody>\n                            <tr>\n                                <td>Badges:</td>\n                                <td class=\"text-right\">${badges}</td>\n                            </tr>\n                            <tr>\n                                <td>Pokédex:</td>\n                                <td class=\"text-right\">${pokedex}</td>\n                            </tr>\n                            <tr>\n                                <td>Time:</td>\n                                <td class=\"text-right\">${_GameConstants__WEBPACK_IMPORTED_MODULE_0__[\"formatTimeFullLetters\"](seconds)}</td>\n                            </tr>\n                        </tbody>\n                    </table>\n                    <img class=\"pokemon-0\" src=\"assets/images/${pokemonShiny ? 'shiny' : ''}pokemon/${pokemon}.png\"/>\n                    <small class=\"version\">v${version}</small>\n                    <div class=\"challenge-badges\">${Object.entries(challenges).filter(([, v]) => v).map(([c]) => `<img class=\"m-1\" width=\"24px\" src=\"${challengeRibbonsPath}${c}.png\" onerror=\"this.remove()\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"${_GameConstants__WEBPACK_IMPORTED_MODULE_0__[\"camelCaseToString\"](c)}\"/>`).join('')}</div>\n                </div>\n            </div>\n        </div>\n        `;\r\n    }\r\n    initialize() {\r\n        // Load trainer card preview\r\n        this.name.subscribe(() => this.updatePreview());\r\n        this.trainer.subscribe(() => this.updatePreview());\r\n        this.pokemon.subscribe((value) => {\r\n            const shiny = App.game.party.alreadyCaughtPokemon(value, true);\r\n            this.pokemonShiny(shiny);\r\n            // Update preview after checking for shiny\r\n            this.updatePreview();\r\n        });\r\n        this.background.subscribe(() => this.updatePreview());\r\n        this.textColor.subscribe(() => this.updatePreview());\r\n        this.updatePreview();\r\n    }\r\n    updatePreview() {\r\n        document.getElementById('profile-trainer-card').innerHTML = Profile.getTrainerCard(this.name(), this.trainer(), this.pokemon(), this.pokemonShiny(), this.background(), this.textColor(), App.game.badgeCase.badgeList.filter((b) => b()).length, App.game.party.caughtPokemon.length, App.game.statistics.secondsPlayed(), App.game.update.version, App.game.challenges.toJSON().list);\r\n    }\r\n    fromJSON(json) {\r\n        if (!json || !json.name) {\r\n            return;\r\n        }\r\n        if (json.name)\r\n            this.name(decodeURI(json.name));\r\n        if (json.trainer !== undefined)\r\n            this.trainer(json.trainer);\r\n        if (json.pokemon !== undefined)\r\n            this.pokemon(json.pokemon);\r\n        if (json.pokemonShiny !== undefined)\r\n            this.pokemonShiny(json.pokemonShiny);\r\n        if (json.background !== undefined)\r\n            this.background(json.background);\r\n        if (json.textColor)\r\n            this.textColor(json.textColor);\r\n    }\r\n    toJSON() {\r\n        return {\r\n            name: encodeURI(this.name()),\r\n            trainer: this.trainer(),\r\n            pokemon: this.pokemon(),\r\n            pokemonShiny: this.pokemonShiny(),\r\n            background: this.background(),\r\n            textColor: this.textColor(),\r\n        };\r\n    }\r\n}\r\nProfile.MAX_TRAINER = 119;\r\nProfile.MAX_BACKGROUND = 40;\r\n\n\n//# sourceURL=webpack:///./src/modules/profile/Profile.ts?");
...
/***/ "./src/modules/settings/CssVariableSetting.ts":
/*!****************************************************!*\
  !*** ./src/modules/settings/CssVariableSetting.ts ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _SaveSelector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SaveSelector */ \"./src/modules/SaveSelector.ts\");\n/* harmony import */ var _profile_Profile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile/Profile */ \"./src/modules/profile/Profile.ts\");\n/* harmony import */ var _DataStore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DataStore */ \"./src/modules/DataStore/index.ts\");\n/* harmony import */ var _GameConstants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GameConstants */ \"./src/modules/GameConstants.ts\");\n/* harmony import */ var _GameHelper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GameHelper */ \"./src/modules/GameHelper.ts\");\n/* harmony import */ var _LogEvent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LogEvent */ \"./src/modules/LogEvent.ts\");\n/* harmony import */ var _enums_Badges__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./enums/Badges */ \"./src/modules/enums/Badges.ts\");\n/* harmony import */ var _enums_PokemonType__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./enums/PokemonType */ \"./src/modules/enums/PokemonType.ts\");\n/* harmony import */ var _enums_ItemType__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./enums/ItemType */ \"./src/modules/enums/ItemType.ts\");\n/* harmony import */ var _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./settings/BooleanSetting */ \"./src/modules/settings/BooleanSetting.ts\");\n/* harmony import */ var _settings_RangeSetting__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./settings/RangeSetting */ \"./src/modules/settings/RangeSetting.ts\");\n/* harmony import */ var _settings_Setting__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./settings/Setting */ \"./src/modules/settings/Setting.ts\");\n/* harmony import */ var _settings_SettingOption__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./settings/SettingOption */ \"./src/modules/settings/SettingOption.ts\");\n/* harmony import */ var _weather_WeatherType__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./weather/WeatherType */ \"./src/modules/weather/WeatherType.ts\");\n/* harmony import */ var _weather_Weather__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./weather/Weather */ \"./src/modules/weather/Weather.ts\");\n/* harmony import */ var _utilities_SeededRand__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./utilities/SeededRand */ \"./src/modules/utilities/SeededRand.ts\");\n/* harmony import */ var _utilities_Rand__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./utilities/Rand */ \"./src/modules/utilities/Rand.ts\");\n/* harmony import */ var _settings_index__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./settings/index */ \"./src/modules/settings/index.ts\");\n/* harmony import */ var _settings_SortOptions__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./settings/SortOptions */ \"./src/modules/settings/SortOptions.ts\");\n/* harmony import */ var _notifications_NotificationConstants__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./notifications/NotificationConstants */ \"./src/modules/notifications/NotificationConstants.ts\");\n/* harmony import */ var _notifications_Notifier__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./notifications/Notifier */ \"./src/modules/notifications/Notifier.ts\");\n/* harmony import */ var _logbook_LogBook__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./logbook/LogBook */ \"./src/modules/logbook/LogBook.ts\");\n/* harmony import */ var _logbook_LogBookTypes__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./logbook/LogBookTypes */ \"./src/modules/logbook/LogBookTypes.ts\");\n/* harmony import */ var _changelog_ChangelogItems__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./changelog/ChangelogItems */ \"./src/modules/changelog/ChangelogItems.ts\");\n/* harmony import */ var _codes_RedeemableCode__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./codes/RedeemableCode */ \"./src/modules/codes/RedeemableCode.ts\");\n/* harmony import */ var _breeding_EggType__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./breeding/EggType */ \"./src/modules/breeding/EggType.ts\");\n/* harmony import */ var _multiplier_Multiplier__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./multiplier/Multiplier */ \"./src/modules/multiplier/Multiplier.ts\");\n/* harmony import */ var _multiplier_MultiplierType__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./multiplier/MultiplierType */ \"./src/modules/multiplier/MultiplierType.ts\");\n/* harmony import */ var _specialEvents_SpecialEvent__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./specialEvents/SpecialEvent */ \"./src/modules/specialEvents/SpecialEvent.ts\");\n/* harmony import */ var _challenges_Challenges__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./challenges/Challenges */ \"./src/modules/challenges/Challenges.ts\");\n/* harmony import */ var _party_LevelType__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./party/LevelType */ \"./src/modules/party/LevelType.ts\");\n/* harmony import */ var _wallet_inject__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./wallet/inject */ \"./src/modules/wallet/inject.ts\");\n/* harmony import */ var _utilities_GenericProxy__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./utilities/GenericProxy */ \"./src/modules/utilities/GenericProxy.ts\");\n/* harmony import */ var _Credits__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./Credits */ \"./src/modules/Credits.ts\");\n/* harmony import */ var _utilities_Modal__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./utilities/Modal */ \"./src/modules/utilities/Modal.ts\");\n// TODO: Remove temporary code after all code in ../scripts has been ported.\r\n// This is only here so that the code in ../scripts can use the new functionality\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nObject.assign(window, Object.assign(Object.assign({ SaveSelector: _SaveSelector__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\r\n    Profile: _profile_Profile__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\r\n    GameConstants: _GameConstants__WEBPACK_IMPORTED_MODULE_3__,\r\n    GameHelper: _GameHelper__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\r\n    LogEvent: _LogEvent__WEBPACK_IMPORTED_MODULE_5__[\"default\"],\r\n    DataStore: _DataStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"], BadgeCase: _DataStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].badge, Statistics: _DataStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].statistics, BadgeEnums: _enums_Badges__WEBPACK_IMPORTED_MODULE_6__[\"default\"],\r\n    PokemonType: _enums_PokemonType__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\r\n    ItemType: _enums_ItemType__WEBPACK_IMPORTED_MODULE_8__[\"default\"],\r\n    BooleanSetting: _settings_BooleanSetting__WEBPACK_IMPORTED_MODULE_9__[\"default\"],\r\n    RangeSetting: _settings_RangeSetting__WEBPACK_IMPORTED_MODULE_10__[\"default\"],\r\n    Setting: _settings_Setting__WEBPACK_IMPORTED_MODULE_11__[\"default\"],\r\n    SettingOption: _settings_SettingOption__WEBPACK_IMPORTED_MODULE_12__[\"default\"],\r\n    WeatherType: _weather_WeatherType__WEBPACK_IMPORTED_MODULE_13__[\"default\"],\r\n    Weather: _weather_Weather__WEBPACK_IMPORTED_MODULE_14__[\"default\"],\r\n    SeededRand: _utilities_SeededRand__WEBPACK_IMPORTED_MODULE_15__[\"default\"],\r\n    Rand: _utilities_Rand__WEBPACK_IMPORTED_MODULE_16__[\"default\"],\r\n    Settings: _settings_index__WEBPACK_IMPORTED_MODULE_17__[\"default\"],\r\n    NotificationConstants: _notifications_NotificationConstants__WEBPACK_IMPORTED_MODULE_19__[\"default\"],\r\n    Notifier: _notifications_Notifier__WEBPACK_IMPORTED_MODULE_20__[\"default\"],\r\n    SortOptionConfigs: _settings_SortOptions__WEBPACK_IMPORTED_MODULE_18__[\"SortOptionConfigs\"],\r\n    SortOptions: _settings_SortOptions__WEBPACK_IMPORTED_MODULE_18__[\"SortOptions\"],\r\n    LogBook: _logbook_LogBook__WEBPACK_IMPORTED_MODULE_21__[\"default\"],\r\n    LogBookTypes: _logbook_LogBookTypes__WEBPACK_IMPORTED_MODULE_22__[\"LogBookTypes\"],\r\n    ChangelogItems: _changelog_ChangelogItems__WEBPACK_IMPORTED_MODULE_23__[\"default\"],\r\n    RedeemableCode: _codes_RedeemableCode__WEBPACK_IMPORTED_MODULE_24__[\"default\"],\r\n    EggType: _breeding_EggType__WEBPACK_IMPORTED_MODULE_25__[\"default\"],\r\n    Multiplier: _multiplier_Multiplier__WEBPACK_IMPORTED_MODULE_26__[\"default\"],\r\n    MultiplierType: _multiplier_MultiplierType__WEBPACK_IMPORTED_MODULE_27__[\"default\"],\r\n    SpecialEvent: _specialEvents_SpecialEvent__WEBPACK_IMPORTED_MODULE_28__[\"default\"],\r\n    Challenges: _challenges_Challenges__WEBPACK_IMPORTED_MODULE_29__[\"default\"],\r\n    LevelType: _party_LevelType__WEBPACK_IMPORTED_MODULE_30__[\"default\"],\r\n    levelRequirements: _party_LevelType__WEBPACK_IMPORTED_MODULE_30__[\"levelRequirements\"] }, _wallet_inject__WEBPACK_IMPORTED_MODULE_31__[\"default\"]), { GenericProxy: _utilities_GenericProxy__WEBPACK_IMPORTED_MODULE_32__[\"default\"],\r\n    SpriteCredits: _Credits__WEBPACK_IMPORTED_MODULE_33__[\"SpriteCredits\"],\r\n    CodeCredits: _Credits__WEBPACK_IMPORTED_MODULE_33__[\"CodeCredits\"],\r\n    modalUtils: _utilities_Modal__WEBPACK_IMPORTED_MODULE_34__ }));\r\n\n\n//# sourceURL=webpack:///./src/modules/temporaryWindowInjection.ts?");

/***/ }),

/***/ "./src/modules/utilities/GenericProxy.ts":
/*!***********************************************!*\
  !*** ./src/modules/utilities/GenericProxy.ts ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst GenericProxy = Proxy;\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (GenericProxy);\r\n\n\n//# sourceURL=webpack:///./src/modules/utilities/GenericProxy.ts?");

/***/ }),

/***/ "./src/modules/utilities/Modal.ts":
/*!****************************************!*\
  !*** ./src/modules/utilities/Modal.ts ***!
  \****************************************/
/*! exports provided: observableState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"observableState\", function() { return observableState; });\nvar ModalState;\r\n(function (ModalState) {\r\n    ModalState[\"hidden\"] = \"hidden\";\r\n    ModalState[\"hide\"] = \"hide\";\r\n    ModalState[\"show\"] = \"show\";\r\n})(ModalState || (ModalState = {}));\r\nfunction createStateObservable(modalID) {\r\n    const obs = ko.observable(ModalState.hidden);\r\n    $(document).ready(() => {\r\n        const $modal = $(`#${modalID}`);\r\n        if (!$modal.length) {\r\n            console.error(`Modal ${modalID} not found; cannot create state observable`);\r\n        }\r\n        else {\r\n            obs(ModalState[$modal.hasClass('show') ? 'show' : 'hidden']);\r\n            Object.values(ModalState).forEach((st) => {\r\n                $modal.on(`${st}.bs.modal`, () => obs(st));\r\n            });\r\n        }\r\n    });\r\n    return obs;\r\n}\r\n// eslint-disable-next-line import/prefer-default-export\r\nconst observableState = new Proxy({}, {\r\n    get(target, modalID) {\r\n        if (!target[modalID]) {\r\n            // eslint-disable-next-line no-param-reassign\r\n            target[modalID] = createStateObservable(modalID);\r\n        }\r\n        return target[modalID]();\r\n    },\r\n});\r\n\n\n//# sourceURL=webpack:///./src/modules/utilities/Modal.ts?");
